...
const PRODUCTS_UPLOAD = path.join(__dirname, '../../uploads/products');

if (!fs.existsSync(PRODUCTS_UPLOAD)) {
  fs.mkdirSync(PRODUCTS_UPLOAD, { recursive: true });
}
...
const storage = multer.diskStorage({
  destination: (_req, _file, cb) => cb(null, PRODUCTS_UPLOAD),
