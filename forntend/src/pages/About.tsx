...
// Business partners moved to PartnersSlider component
            ...
            <div className="relative">
              <div className="bg-primary/10 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative w-full aspect-[4/3] flex items-center justify-center">
                  ...
                  {/* Location markers */}
                  <div className="absolute top-[18%] left-[22%] flex items-center gap-2">
                    <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                    <span className="text-sm font-semibold">TABUK</span>
                  </div>
                  <div className="absolute top-[28%] right-[18%] flex items-center gap-2">
                    <span className="text-sm font-semibold">JUBAIL</span>
                    <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                  </div>
                  <div className="absolute top-[42%] right-[28%] flex items-center gap-2">
                    <span className="text-sm font-semibold">RIYADH</span>
                    <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                  </div>
                  <div className="absolute top-[52%] left-[12%] flex items-center gap-2">
                    <span className="text-sm font-semibold">THUWAL</span>
                    <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                  </div>
                  <div className="absolute top-[60%] left-[14%] flex items-center gap-2">
                    <span className="text-sm font-semibold">JEDDAH</span>
                    <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                  </div>
                </div>
              </div>
